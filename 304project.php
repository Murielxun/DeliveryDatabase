<!--Test Oracle file for UBC CPSC304 2018 Winter Term 1
  ...
  <html>
    ...
    <body class="body1">
        ...
        <form method="GET" action="304project.php"> <!--refresh page when submitted-->
        ...
        <h2>Display the Tuples in Table</h2>
        <form method="GET" action="304project.php"> <!--refresh page when submitted-->
		...
		<hr />
        <h2>Delete the Tuples in Table</h2>
        <form method="POST" action="304project.php"> <!--refresh page when submitted-->
            <input type="hidden" id="displayRequest" name="displayRequest">
            <input type="submit" value="Submit Query" name="displayTuples"></p>
        </form>
		...
		<hr />
        <h2>Select the Tuples in Table</h2>
        <form method="POST" action="304project.php"> <!--refresh page when submitted-->
            <input type="hidden" id="displayRequest" name="displayRequest">
            <input type="submit" value="Submit Query" name="displayTuples"></p>
        </form>
	...
	// A better coding practice is to have one method that reroutes your requests accordingly. It will make it easier to add/remove functionality.
		...
		if (isset($_POST['reset']) || isset($_POST['updateSubmit']) || isset($_POST['insertSubmit'])) {
            ...
            handleGETRequest();
        } else if (isset($_GET['displayRequest'])) {
            handleGETRequest();
        }
		?>
	</body>
